...
class MailChimpImport {
   ...
   */
  constructor (mcAudienceId, mcUserName, mcApiKey, campaignDataCollectionName, reportDataCollectionName, mcApiUrl = DEFAULT_MC_API_URL, dbConnString = MailChimpImport.connString) {
